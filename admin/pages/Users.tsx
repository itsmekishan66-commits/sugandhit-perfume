                        ...
                        <td className="p-3">
                          <div className="flex items-center gap-3">
                            {customer.image ? (
                              ...
                              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-gold to-espresso text-white text-sm font-semibold">
                ...
                <div className="p-6 border-b border-gold/15">
                  <div className="flex items-center gap-4">
                    {detail.user.image ? (
                      ...
                      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-gold to-espresso text-white text-2xl font-semibold">
