...
const Dashboard = ({ token }) => {
  const [stats, setStats] = useState({ products: 0, orders: 0, custom: 0, revenue: 0, pending: 0 });
              ...
              {recent.map((o) => (
                <li key={o.type + o._id} className="py-2.5 flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-ink-soft">{new Date(o.date).toLocaleDateString()}</p>
                  </div>
