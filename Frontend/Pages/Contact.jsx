      ...
      <Reveal className="max-w-4xl mx-auto card-lux rounded-4xl p-8 md:p-12">
        <form onSubmit={onSubmitHandler} className="grid sm:grid-cols-2 gap-6">
          <div>
            ...
            <input className={inputClass} type="text" required placeholder="e.g. Aarav Shakya" />
          </div>
          <div>
            <label className={labelClass}>Email</label>
            <input className={inputClass} type="email" required placeholder="you@example.com" />
          </div>
          <div>
            <label className={labelClass}>Subject</label>
            <input className={inputClass} type="text" required placeholder="Custom blend query…" />
          </div>
          <div>
            <label className={labelClass}>Concern</label>
            <select className={inputClass + ' select-soft'} required defaultValue="">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea className={inputClass} rows="5" required placeholder="Tell us about the scent you’re after…"></textarea>
          </div>
