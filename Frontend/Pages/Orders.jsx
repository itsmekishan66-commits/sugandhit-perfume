...
const Orders = () => {
  ...
  const allOrders = [
    ...customOrders.map(o => ({ type: 'custom', _id: o._id, date: o.date, status: o.status, name: `${o.name} ✦ Custom`, amount: o.amount })),
    ...orders.map(o => ({ type: 'order', _id: o._id, date: o.date, status: o.status, name: (o.items || [])[0]?.name || 'Order', amount: o.amount })),
