...
const CustomPerfume = () => {
  ...
  const placeOrder = async (e) => {
    ...
    if (!address.name || !address.phone || !address.address) { toast.error('Fill in your delivery details'); return; }
  ...
  const onChange = (e) => setAddress(d => ({ ...d, [e.target.name]: e.target.value }));
